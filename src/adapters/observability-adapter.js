...
/**
 * observability-adapter.js (FINAL STABLE - COMMONJS)
 *
 * ✅ No ESM issues
...
try {
  logger = require('../utils/logger'); // path relative to src/adapters/
} catch (e) {
  logger = {
