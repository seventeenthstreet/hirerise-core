 ...
 *   Table: edu_education_roi
 *   Index 1: student_id ASC, roi_score DESC
 *   Index 2: student_id ASC, created_at DESC
 *
 * Run these in the Supabase SQL editor:
 *
 *   CREATE INDEX IF NOT EXISTS idx_edu_education_roi_student_score
 *     ON edu_education_roi (student_id ASC, roi_score DESC);
 *
 *   CREATE INDEX IF NOT EXISTS idx_edu_education_roi_student_created
 *     ON edu_education_roi (student_id ASC, created_at DESC);
 *
 * Usage:
...
async function run(dryRun = true) {
  ...
  console.log('  1. Table: edu_education_roi');
  console.log('     Fields: student_id ASC, roi_score DESC');
  console.log('  2. Table: edu_education_roi');
  ...
  console.log('✅  Sentinel row upserted to edu_education_roi.');
  console.log('\n📋  Next steps:');
