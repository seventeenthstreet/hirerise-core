...
// FIXED: replaced db.runTransaction / txn.get / txn.update with supabase.rpc('deduct_credits')
// The RPC is an atomic Postgres function that checks balance and decrements in one transaction.
...
// FIXED: replaced db.runTransaction / txn.get / txn.update with supabase.rpc('refund_credits')
